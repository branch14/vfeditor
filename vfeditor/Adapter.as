package vfeditor {
    ...
    public class Adapter {
        ...
        public function fragmentsFrom(id:int,
				      result:Function,
				      fault:Function):void {
        }
        ...
        private function _buildLoader(result:Function,
				      fault:Function):URLLoader {
        ...
        private function _requestGet(path:String, data:Array,
            ...
            data.push("credentials="+_config.credentials);
            url += "?"+data.join("&");
            trace("[DEBUG] GET "+url);
